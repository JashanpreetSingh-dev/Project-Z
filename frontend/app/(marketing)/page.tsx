    ...
    <>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-8 md:grid-cols-3 max-w-5xl mx-auto">
            ...
            <div className="relative text-center">
              <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-2xl gradient-bg text-white text-2xl font-bold">
                1
              </div>
              <h3 className="text-xl font-semibold mb-3">Customer Calls</h3>
      ...
      <section className="border-t bg-muted/30 py-24">
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-8 md:grid-cols-3 max-w-5xl mx-auto stagger-children">
            {/* Testimonial 1 */}
